...
exports.default = (function (_a) {
    var catRepository = _a.catRepository;
    return {
        listCats: function () {
        ...
        findCat: function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, catRepository.findCat(id)];
                        case 1:
                            cat = _a.sent();
                            if (!cat) {
                                throw new error_handling_middleware_1.CustomError({ statusCode: 404, code: 'resource-not-found' });
                            }
                            return [2 /*return*/, cat];
                    }
                });
        ...
        removeCat: function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, catRepository.removeCat(id)];
                        case 1:
                            cat = _a.sent();
                            if (!cat) {
                                throw new error_handling_middleware_1.CustomError({ statusCode: 404, code: 'resource-not-found' });
